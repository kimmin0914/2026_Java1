...
public class ReplaceAllTest {
    public static void main(String[] args) {
        ...
        s1 = "인공지능소프트웨어과 1학년";
        System.out.println("\"지능\"의 인덱스: " + s1.indexOf("지능")); // 2
        System.out.println("\'웨\'의 인덱스: " + s1.indexOf("웨"));// 7

        s1 = "한국에는 한국 폴리텍대학이 한국 전체에 많은 곳에 캠퍼스가 위치해 있습니다.";
        System.out.println("s1의 4번 위치부터 한국 이라는 문자열을 찾아서 인덱스 번호: " + s1.indexOf("한국", 4)); // 5
